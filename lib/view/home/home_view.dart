    ...
    return Container(
      ...
      child: Column(
        children: [
          const CircleAvatar(
            radius: 50,
            backgroundImage: AssetImage('assets/img/download (3).jpg'),
          ),
          const SizedBox(
            height: 8,
          ),
          Text("Menna Mohamed", style: textTheme.displayMedium),
          //Text("student", style: textTheme.displaySmall),
          Container(
...
class MyAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  Size get preferredSize =>
      const Size.fromHeight(132); // Adjust height if needed
}
