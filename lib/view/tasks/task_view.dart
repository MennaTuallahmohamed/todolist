...
class _TaskViewState extends State<TaskView> {
  ...
  bool isTaskAlreadyExistBool() {
    // Check if either taskControllerForTitle or taskControllerForSubtitle is null
    if (widget.taskControllerForTitle == null ||
        widget.taskControllerForSubtitle == null) {
      return false; // Return false if either controller is null (assuming task does not exist)
    }
...
class MyAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Size get preferredSize =>
      const Size.fromHeight(150); // Use the height defined in the SizedBox
}
